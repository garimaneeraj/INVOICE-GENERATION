...
public class MainLoginPage {
	...
	private void initialize() {
		...
		frame.add(lblBillingSoftware);
		
		JLabel lblSoftware = new JLabel("Invoice Generation Software");
		lblSoftware.setHorizontalAlignment(SwingConstants.CENTER);
		lblSoftware.setFont(new Font("LT Medium", Font.PLAIN, 30));
		lblSoftware.setBounds(0, 52, 884, 72);
		frame.getContentPane().add(lblSoftware);
